...
// Generate a random secret key (32 bytes in this example)
...
const secretKey = '56b1a8316212d865f010b72526558eb7ab3a0ceb9a8723669614206ab890b3da';  // Use the same key here

const sessionStore = new MySQLStore({
    secret: secretKey,
    /* Your MySQL store configuration */
});
...
app.get('/document', (req, res) => {
    fetchAdminDashboardData(req, (error, adminDashboardData) => {
        ...
        res.render('admin/admin_dashboard', adminDashboardData);
    });
});
