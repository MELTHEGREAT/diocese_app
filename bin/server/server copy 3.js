...
// app.get('/members/member_dashboard', (req, res) => {
...
//                     res.status(500).send('Internal Server Error');
//                 } else {
//                     const showSuccessMessage = 'Submitted Successfully';
//                     res.render('members/member_dashboard', {
//                         userEmail,
//                         messages,
//                         userId: req.session.id || 28,
...
//     connection.query(getNotificationQuery, [userId], (err, notifications) => {
//         if (err) {
...
function fetchAndRenderFinancialReports(res, selectedMonth) {
    ...
    connection.query(incomeQuery, (errorIncome, resultsIncome, fieldsIncome) => {
        ...
        connection.query(expensesQuery, (errorExpenses, resultsExpenses, fieldsExpenses) => {
            ...
            // res.render('admin/financial_reports', { userEmail, successMessage, incomeData: filteredIncomeData, expensesData: formattedExpensesData, totalIncome, totalExpenses, netIncomeLoss, moment });
...
function filterData(selectedMonth) {
    fetchAndRenderFinancialReports(selectedMonth);
}
...
//     fetchAndRenderFinancialReports(res,selectedMonth);
// });
app.get('/to_financial_reports', (req, res) => {
    const selectedMonth = req.query.selectedMonth || ''; // Get selected month from query parameter
    fetchAndRenderFinancialReports(selectedMonth, res);
});
