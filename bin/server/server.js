                                        ...
                                        connection.query(countUsersQuery, (err, usersCountResult) => {
                                            ...
                                            connection.query(countStaRitaUsersQuery, (staRitaUsersErr, staRitaUsersCountResult) => {
                                                ...
                                                if (user.role === 'admin') {                                                   
                                                    ...
                                                    // Call the function with the available variables
...
//     const query = 'SELECT * FROM baptismal_request WHERE request_status <> "Done"';
...
//       res.render('admin/baptismal_request', { data: results,confirmationMessage });
//     });
//   });
...
app.delete('/deleteIncome', (req, res) => {
  ...
  connection.query(deleteQuery, [incomeIdToDelete], (error, results) => {
    ...
    //  res.json({ success: true, message: 'Record deleted successfully.' });
     ...
     res.render('/to_financial_reports');
    }
  });   
});
